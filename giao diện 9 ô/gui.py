...
btn_stochastic_hill_climbing = tk.Button(button_frame, image=img_stochastic_hill_climbing, command=lambda: (restore_main_text_widget(), run_hill_climbing(), solve_puzzle_stochastic_giao_dien(start, x, y)))
